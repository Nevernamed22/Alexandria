...
namespace Alexandria.DungeonAPI
{
    ...
    public static class DungeonHandler
    {
        ...
        public static void Register(RoomData roomData)
        {
            ...
            {
                StaticReferences.RoomTables[roomData.specialRoomPool].includedRooms.Add(wRoom);
                if (room.category == RoomCategory.BOSS)
                {
                    room.associatedMinimapIcon = RoomIcons.BossRoomIcon;
                }
            }
            else if (roomData.superSpecialRoomType != null && roomData.superSpecialRoomType.ToLower() != "none")
            {
                ...
                switch (roomData.superSpecialRoomType.ToLower())
                {
                    ...
                    case "fuselier":
                        ...
                        break;
                    case "black_market_entrance":
                        StaticReferences.RoomTables["black_market_entrance"].includedRooms.Add(wRoom);
                        break;
                    case "black_market":
